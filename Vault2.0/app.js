...
function showToast(message, type = "success") {
  ...
  switch (type) {
    case "success":
      bgColor = isDark ? "bg-green-800" : "bg-green-600";
      textColor = "text-white";
      borderColor = isDark ? "border-green-600" : "border-green-500";
      break;
    case "error":
      bgColor = isDark ? "bg-red-800" : "bg-red-600";
      textColor = "text-white";
      borderColor = isDark ? "border-red-600" : "border-red-500";
      break;
    case "info":
      bgColor = isDark ? "bg-blue-800" : "bg-blue-600";
      textColor = "text-white";
      borderColor = isDark ? "border-blue-600" : "border-blue-500";
      break;
    default:
      bgColor = isDark ? "bg-gray-800" : "bg-gray-700";
      textColor = "text-white";
      borderColor = isDark ? "border-gray-600" : "border-gray-500";
  }

  toast.className = `toast-notification fixed bottom-4 right-4 px-4 py-3 rounded-lg font-medium z-50 transition-all duration-300 transform translate-y-0 opacity-100 shadow-lg border ${bgColor} ${textColor} ${borderColor}`;
        ...
        <div class="w-full py-8">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
                ...
                <div class="p-8 border-b border-gray-100 dark:border-gray-700">
                    ...
                    <input type="text" id="generator-output" readonly class="w-full px-4 py-4 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-600 rounded-xl font-mono text-lg text-gray-900 dark:text-gray-100 focus:outline-none select-all">
                    
                    <!-- Strength Indicator -->
                    <div class="mt-6 flex items-center justify-between">
                        <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Password Strength</span>
                        <span id="strength-text" class="text-sm font-semibold text-green-600 dark:text-green-400">Strong</span>
                    </div>
                    <div class="mt-2 w-full bg-gray-200 dark:bg-gray-700 rounded-full h-1">
                        <div id="strength-bar" class="bg-green-500 h-1 rounded-full transition-all duration-500" style="width: 80%"></div>
                    </div>
                    <div id="strength-details" class="mt-3 flex flex-wrap gap-x-6 gap-y-1 text-xs text-gray-500 dark:text-gray-400">
                        <span>✓ Uppercase</span>
                        <span>✓ Lowercase</span>
                        <span>✓ Numbers</span>
                        <span>✓ Symbols</span>
          ...
          <div class="grid md:grid-cols-3 gap-8 items-stretch">
            ...
            <div class="flex flex-col h-full">
              ...
              <div class="space-y-2 md:space-y-0 md:flex-1 md:flex md:flex-col md:justify-between">
            ...
            <div class="flex flex-col h-full">
              ...
              <div class="space-y-2 md:space-y-0 md:flex-1 md:flex md:flex-col md:justify-between">
                                <button id="generate-passphrase-btn" class="w-full p-3 text-sm text-left rounded-lg border border-gray-200 dark:border-gray-600 hover:border-gray-300 dark:hover:border-gray-500 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-200">
                                ...
                                <button id="generate-pin-btn" class="w-full p-3 text-sm text-left rounded-lg border border-gray-200 dark:border-gray-600 hover:border-gray-300 dark:hover:border-gray-500 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-200">
